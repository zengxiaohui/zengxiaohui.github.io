...
$.validator.addMethod( "integer", function( value, element ) {//整数
...
$.validator.addMethod( "mobilePhone", function( value, element ) {
	return this.optional( element ) || /^(0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?$|(^0?(13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}$)/.test( value );
}, "Letters or punctuation only please" );
...
$.validator.addMethod( "phone", function( value, element ) {
	return this.optional( element ) || /^0?(13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}$/.test( value );
