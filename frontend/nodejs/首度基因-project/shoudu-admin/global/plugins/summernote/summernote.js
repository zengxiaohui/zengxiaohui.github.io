...
(function (factory) {
  ...
  /*   this.imageShape = function (value) {
  ...
  var Buttons = function (context) {
    ...
    /*  context.memo('button.shapeCircle', function (){
          return ui.button({
          contents: ui.icon(options.icons.circle),
          tooltip: lang.image.shapeCircle,
          click: context.createInvokeHandler('editor.imageShape', 'none')
        }).render();
        });*/
