        ...
        return {
            ...
            link: function(scope, element, attributes) {
                            ...
                            if (ratio > 1) {
                               /* console.log(scope.width);
                                ...
                                if (ratio > scope.width/scope.height) {
                                    width = width * (scope.height/height);
                                    height = scope.height;
                                } else {
                                    height = (scope.width/width) * height;
                                    width = scope.width;
                ...
                $img.onload = function() {
                    ...
                    // 新增代码开始
                    if (scope.width == imgWidth) {
                        if (scope.height < imgHeight) maxZoomedInLevel = 1;
                    } else if (scope.height == imgHeight) {
                        if (scope.width < imgWidth) maxZoomedInLevel = 1;
                    }
                    //新增代码结束
                    // console.log(maxZoomedInLevel);
