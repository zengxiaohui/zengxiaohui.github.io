angular.module('adminApp').factory('pluginsService', ['$timeout', function($timeout) {
    /* ==========================================================*/
    /* PLUGINS                                                   */
    /* ========================================================= */
    /**** Color Picker ****/
    // AV.initialize('3mrYVUrTSWDwaxpvK4206Cja-gzGzoHsz', 'sKg0pdr4iH6RkaEnytJTPuXf');
    ...
    function rating() {
        $('.rateit').each(function() {
            ...
            if ($(this).parent().find('.rating-value')) {
                $(this).parent().find('.rating-value').text('评分:' + ($(this).rateit('value') - 1).toFixed(1));
                /*$(this).bind('rated', function(event, value) {
                    ...
                    callbacks: {
                        ...
                        onImageUpload: function(files) {
                            ...
                            avFile.save().then(function(data) {
                                ...
                                //  this.summernote('insertImage', data.attributes.url, files[0].name);
                                $('.summernote').summernote('insertImage', data.attributes.url, files[0].name);
                            }, function(error) {
                                console.log("图片上传失败");
    ...
    //                             var name = 'banner-content.jpg';
    //                             var avFile = new AV.File(name, n);
    //                             avFile.save().then(function(data) {
    //                                 console.log(data);
    //                                 $('.summernote').summernote('insertImage', data._url, function($image) {
    //                                     console.log();
    //                                     console.log($image);
    ...
    //     //    $('#'+n).wrap('<figure class="effect-marley"></figure>');
    //     // });
    // }
